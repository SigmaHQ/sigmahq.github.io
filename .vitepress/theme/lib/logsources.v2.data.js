    ...
    async load() {
        return Promise.resolve({
            'logsources': [{
                ...
                "yaml": "logsource:\n  category: accounting\n  product: cisco\n  service: aaa\n",
                "logsource": {"category": "accounting", "product": "cisco", "service": "aaa"},
                ...
                "tags": ["cloud", "gcp", "gcp.audit", "google", "platform", "platform.audit"]
            }, {
                "title": "Google Workspace - Google Workspace.Admin",
                "yaml": "logsource:\n  product: google_workspace\n  service: google_workspace.admin\n",
                "logsource": {"service": "google_workspace.admin", "product": "google_workspace"},
                "tags": ["google", "google_workspace", "google_workspace.admin", "workspace", "workspace.admin"]
            }, {
                "title": "Linux",
                "yaml": "logsource:\n  product: linux\n",
                ...
                "logsource": {"product": "windows", "service": "codeintegrity-operational"},
                "tags": ["codeintegrity", "codeintegrity-operational", "operational", "windows"]
            }, {
                "title": "Windows - Create Remote Thread",
                "yaml": "logsource:\n  category: create_remote_thread\n  product: windows\n",
                "logsource": {"category": "create_remote_thread", "product": "windows"},
                "tags": ["create", "create_remote_thread", "remote", "thread", "windows"]
            }, {
                ...
                "logsource": {"product": "windows", "service": "microsoft-servicebus-client"},
                "tags": ["client", "microsoft", "microsoft-servicebus-client", "servicebus", "windows"]
            }, {
                "title": "Windows - Msexchange Management",
                "yaml": "logsource:\n  product: windows\n  service: msexchange-management\n",
                "logsource": {"service": "msexchange-management", "product": "windows"},
                "tags": ["management", "msexchange", "msexchange-management", "windows"]
            }, {
                ...
                "logsource": {"category": "ps_classic_provider_start", "product": "windows"},
                "tags": ["classic", "powershell", "provider", "ps_classic_provider_start", "start", "windows"]
            }, {
                "title": "Windows - Powershell Classic Start",
                "yaml": "logsource:\n  category: ps_classic_start\n  product: windows\n",
                "logsource": {"category": "ps_classic_start", "product": "windows"},
                "tags": ["classic", "powershell", "ps_classic_start", "start", "windows"]
            }, {
                ...
                "logsource": {"product": "windows", "service": "printservice-operational"},
                "tags": ["operational", "printservice", "printservice-operational", "windows"]
            }, {
                ...
                "logsource": {"service": "terminalservices-localsessionmanager", "product": "windows"},
                "tags": ["localsessionmanager", "terminalservices", "terminalservices-localsessionmanager", "windows"]
            }, {
                "title": "Windows - WMI",
                "yaml": "logsource:\n  product: windows\n  service: wmi\n",
